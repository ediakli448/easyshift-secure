...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/admin/create-org" element={<AuthedShell><CreateOrgPage /></AuthedShell>} />
      <Route path="/admin" element={<AuthedShell><AdminDashboard /></AuthedShell>} />
      <Route path="/admin/settings" element={<AuthedShell><OrgSettingsPage /></AuthedShell>} />
      <Route path="/admin/schedule" element={<AuthedShell><ScheduleBuilderPage /></AuthedShell>} />
      <Route path="/admin/swaps" element={<AuthedShell><SwapApprovalsPage /></AuthedShell>} />
